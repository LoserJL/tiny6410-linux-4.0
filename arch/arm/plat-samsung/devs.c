...
/*
#define MINI6410_PA_LED	0x7F008800

static struct resource s3c_leds_resource[] = {
	[0] = DEFINE_RES_MEM(MINI6410_PA_LED, SZ_16),
};

struct platform_device s3c_device_leds = {
	.name		= "mini6410-leds",
	.id		= -1,
	.num_resources	= ARRAY_SIZE(s3c_leds_resource),
	.resource	= s3c_leds_resource,
};
*/
